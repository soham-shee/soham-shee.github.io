...
export default function LayoutBlogPost({
  ...
  return (
    <>
      <div className="pointer-events-none fixed left-0 top-0 z-10 h-15 w-full bg-gray-100 to-transparent backdrop-blur-xl [-webkit-mask-image:linear-gradient(to_bottom,black,transparent)] dark:bg-zinc-950" />
      <ScrollProgress
        className="fixed top-0 z-20 h-0.5 bg-slate-600 dark:bg-zinc-600"
        springOptions={{
          bounce: 0,
        }}
      />
