...
function ProjectImage({ src }: ProjectImageProps) {
  return (
    ...
    >
      ...
      <MorphingDialogContainer>
        <MorphingDialogContent className="relative aspect-image rounded-2xl bg-zinc-50 p-1 ring-1 ring-zinc-200/50 ring-inset dark:bg-zinc-950 dark:ring-zinc-800/50">
          <img
            src={src}
            alt="Project"
            className="aspect-video h-[50vh] w-full rounded-2xl object-contain md:h-[70vh]"
          />
        </MorphingDialogContent>
        <MorphingDialogClose
